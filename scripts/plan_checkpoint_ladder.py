...
def main() -> int:
    ...
    parser.add_argument("--ladder", default="5,500,4000")
    parser.add_argument("--stage-budgets", default="5:900,500:3600,4000:21600")
    parser.add_argument("--training-timeouts", default="5:600,500:3000,4000:19800")
